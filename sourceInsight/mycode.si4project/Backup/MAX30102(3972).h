...
#define BUFFER_SIZE 500  // 足够大的缓冲区存储原始信号
#define MIN_HEART_RATE 30  // 最低心率 (BPM)
#define MAX_HEART_RATE 240 // 最高心率 (BPM)
#define CALIBRATION_CONST_A 110.0
#define CALIBRATION_CONST_B 25.0
