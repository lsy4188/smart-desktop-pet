...
void init_MAX30102(void){
	...
	// SPO2配置：采样率400Hz，LED脉冲宽度=411μs (18位分辨率)
	Write_MAX30102_Reg(MAX30102_REG_SPO2_CONFIG,0x4F);
    ...
    Write_MAX30102_Reg(MAX30102_REG_MULTI_LED, 0x21);
	 // 使能新数据就绪中断和温度就绪中断
    Write_MAX30102_Reg(MAX30102_REG_INT_ENABLE, 0x50);
    // 温度测量配置
...
float Read_MAX30102_Temperature(void){
	...
	temp_int=Read_MAX30102_Reg(MAX30102_REG_TEMP_INT);
	temp_fra=Read_MAX30102_Reg(MAX30102_REG_TEMP_FRA);
