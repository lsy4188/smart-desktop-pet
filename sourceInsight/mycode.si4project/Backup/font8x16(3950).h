...
#define __FONT8x16_H__
...
#else
	//ASCII 字符，数据按行存储每行 1 字节，共 16 行）
	// 16 行 ×8 列(128个像素表示一个字符)
	...
	//汉字数据（32 字节数组）采用按列存储规则
	typedef struct{
		const uint8_t gbk[2]; //汉字对应的gbk编码(2个字节)
		const uint8_t data[32];//汉字对应的点阵数据
	}ChineseChar;
	// 32 行 ×8 列
	const ChineseChar chileselib[]={
		{{0xCE, 0xC2},//温
				{0x00, 0x23, 0x12, 0x12, 0x83, 0x42, 0x42,0x13, 
				0x10, 0x27, 0xe4, 0x24, 0x24, 0x24, 0x2f, 0x00,
				0x00, 0xf8, 0x08, 0x08, 0xf8, 0x08, 0x08, 0xf8,
				0x00, 0xfc, 0xa4, 0xa4, 0xa4, 0xa4, 0xfe, 0x00}},
		{{0xCA, 0xA8},//湿
				{0x00, 0x27, 0x14, 0x14, 0x87, 0x44, 0x44, 0x17, 
				0x11, 0x21, 0xe9, 0x25, 0x23, 0x21, 0x2f, 0x00,
				0x00, 0xf8, 0x08, 0x08, 0xf8, 0x08, 0x08, 0xf8, 
				0x20, 0x20, 0x24, 0x28, 0x30, 0x20, 0xfe, 0x00}},
		{{0xB6, 0xC8},//度
				{0x01, 0x00, 0x3f, 0x22, 0x22, 0x3f, 0x22, 0x22,
				0x23, 0x20, 0x2f, 0x24, 0x42, 0x41, 0x86, 0x38,
				0x00, 0x80, 0xfe, 0x20, 0x20, 0xfc, 0x20, 0x20, 
				0xe0, 0x00, 0xf0, 0x10, 0x20, 0xc0, 0x30, 0x0e}},
		{{0xA1, 0xE8},//℃
				{0x60, 0x91, 0x96, 0x6c, 0x08, 0x18, 0x18, 0x18, 
				0x18, 0x18, 0x18, 0x08, 0x0c, 0x06, 0x01, 0x00,
				0x00, 0xf4, 0x0c, 0x04, 0x04, 0x00, 0x00, 0x00, 
				0x00, 0x00, 0x00, 0x00, 0x04, 0x08, 0xf0, 0x00}}
	};
#endif 
